#!/usr/bin/python3
"""
this model contains a Base class to manage
the id attribute of all classes that are extended
from Base and avoid duplicating the same working.
"""
...
class Base:
    ...
    def draw(list_rectangles, list_squares):
        ...
        color_list = ['blue', 'pink', 'yellow', 'brown', 'purple', 'white',
                      'grey']
